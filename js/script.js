...
genshinRandomizer_gameMode -> saving rBans mode index
*/
...
$(document).ready(function () {
	...
	// setup game mode
	let t = localStorage.getItem(`${lsTag}_gameMode`)??0;
	rBans = banTypes[(t-1+banTypes.length) % banTypes.length];
	$("#toggle-character-bans").click();
	// hide buttons
	$("#profile-save").hide();
	$("#profile-cancel").hide();
...
$("#toggle-character-bans").click(function () {
	...
	localStorage.setItem(`${lsTag}_gameMode`, banTypes.indexOf(rBans));
});
